...
class ConfigurationDialog(QDialog, ui_configurationdlg.Ui_CC3DPrefs, ConfigurationPageBase):
    ...
    def updateStylesheet(self):
        # self.tabWidget.tabBar().setStyleSheet(getStylesheet("light"))
        styleManager = StyleManager()
        styleManager.readThemes()
        print("styles",styleManager.getStylesheet("LightTheme"))
        self.setStyleSheet(styleManager.getStylesheet("LightTheme"))
