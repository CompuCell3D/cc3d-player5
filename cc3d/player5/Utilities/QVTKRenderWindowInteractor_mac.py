...
class QVTKRenderWindowInteractor(QVTKRWIBaseClass):
    ...
    def paintEvent(self, ev):
        # pass
        # print self._Iren.GetScale()
        # print self._Iren.SetSize(200,200)
        # print self._Iren.GetSize()
        self._Iren.Render()
...
def QVTKRenderWidgetConeExample():
    ...
    # print render_window.GetRenderingBackend()
    render_window.SetFullScreen(1)

    print(render_window.GetSize())
