...
class Ui_demoDialog(object):
    def setupUi(self, demoDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 519, 99))
        ...
        self.horizontalLayout_4.addWidget(self.selectedDemoNameLabel)
        ...
        self.horizontalLayout_4.addWidget(self.openDemoButton)
